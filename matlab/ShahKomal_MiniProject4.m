...
data = readtable('C:\Users\komal\git\wearable-bioinstrumentation\data\breathing.csv');
...
analyzeRESP(time, resp, true);
ind = time>=120 & time<150;
analyzeRESP(time(ind), resp(ind), true);
